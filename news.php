...
.delete-btn {
    ...
    <script>
        ...
        async function handleSubmit(event) {
            ...
            const response = await fetch("http://localhost/post_article.php", {
                method: "POST",
        ...
        async function fetchArticles() {
            const response = await fetch("http://localhost/get_articles.php");
        ...
        async function deleteArticle(id) {
            await fetch(`http://localhost/delete_article.php?id=${id}`, { method: "DELETE" });
            fetchArticles();
        }
        ...
        async function editArticle(id) {
            ...
            if (newTitle && newDescription) {
                await fetch("http://localhost/update_article.php", {
                    method: "PUT",
                    headers: { "Content-Type": "application/json" },
